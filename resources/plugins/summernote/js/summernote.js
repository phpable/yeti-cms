	...
	var Editor = /** @class */ (function () {
		function Editor(context) {
			...
			var commands = [
				...
				'formatBlock', 'removeFormat', 'foreColor'
			];
			...
			this.createLink = this.wrapCommand(function (linkInfo) {
				...
				$$1.each(anchors, function (idx, anchor) {
					...
					if (nofollow){
						$$1(anchor).attr('rel', 'nofollow');
					}else{
						$$1(anchor).removeAttr('rel');
					}
				});
	...
	var Buttons = /** @class */ (function () {
				...
				children: [
					this.button({
						...
						click: function (e) {
							_this.context.invoke('editor.color', {
								foreColor: $$1(e.currentTarget).attr('data-foreColor')
							});
						}
					}),
					this.button({
					...
					this.ui.dropdown({
						...
						click: function (event) {
							...
							if (lists.contains(['foreColor'], eventName)) {
								$button.closest('.note-color').find('.note-recent-color').css('color', value);
								$button.closest('.note-color').find('.note-current-color-button').attr('data-' + eventName, value);
		...
		Buttons.prototype.addImagePopoverButtons = function () {
			...
			this.context.memo('button.imageSizeAuto', function () {
				return _this.button({
					contents: '<span class="note-fontsize-10">Auto</span>',
					tooltip: _this.lang.image.resizeAuto,
		...
		LinkDialog.prototype.showLinkDialog = function (linkInfo) {
			...
			return $$1.Deferred(function (deferred) {
				...
				_this.ui.onDialogShown(_this.$dialog, function () {
					...
					var isNofollowChecked = linkInfo.nofollow !== undefined
						? linkInfo.nofollow : false;
					$openInNewWindow.prop('checked', isNewWindowChecked);
					$nofollow.prop('checked', isNofollowChecked);
